...
router.post("/send", (req, res) => {
    const {date,shift,operator_name,uwa1,uwa2,uwa3,uwa4,uwa5,uwa6,uwa7,uwa8,uwa9,uwa10,description,status} = req.body
    var sql = `INSERT INTO uwatable (date,machine_Sl_No,shift, checked_by, uwa1, uwa2, uwa3, uwa4, uwa5, uwa6, uwa7, uwa8,uwa9,uwa10,description,status) VALUES ('${date}','Not Provide','${shift}','${operator_name}','${uwa1}','${uwa2}','${uwa3}','${uwa4}','${uwa5}','${uwa6}','${uwa7}','${uwa8}','${uwa9}','${uwa10}','${description}','${status}')`;
