...
router.post("/send", (req, res) => {
    const { date, shift, machine_Sl_No, checked_by, process1_result, process2_result, process3_result, process4_result, process5_result, process6_result, process7_result, process8_result, process9_result, description,status } = req.body
    var sql = `INSERT INTO vaccumetable (date,shift,machine_Sl_No,checked_by, process1_result, process2_result, process3_result, process4_result, process5_result, process6_result, process7_result, process8_result, process9_result,description,status) VALUES ('${date}','${shift}','${machine_Sl_No}','${checked_by}','${process1_result}','${process2_result}','${process3_result}','${process4_result}','${process5_result}','${process6_result}','${process7_result}','${process8_result}','${process9_result}','${description}','${status}')`;
