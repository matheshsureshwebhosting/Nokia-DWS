...
router.post("/send", (req, res) => {
    const {date,shift,operator_name,thermal1,thermal2,thermal3,thermal4,thermal5,thermal6,thermal7,thermal8,thermal9,thermal10,thermal11,thermal12,thermal13,description,status} = req.body
    var sql = `INSERT INTO thermaltable (date,machine_Sl_No,shift, checked_by, thermal1, thermal2, thermal3, thermal4, thermal5, thermal6, thermal7, thermal8,thermal9,thermal10,thermal11,thermal12,thermal13,description,status) VALUES ('${date}','Not Provide','${shift}','${operator_name}','${thermal1}','${thermal2}','${thermal3}','${thermal4}','${thermal5}','${thermal6}','${thermal7}','${thermal8}','${thermal9}','${thermal10}','${thermal11}','${thermal12}','${thermal13}','${description}','${status}')`;
