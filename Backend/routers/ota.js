...
router.post("/send", (req, res) => {
    const {date,shift,operator_name,ota1,ota2,ota3,ota4,ota5,ota6,ota7,ota8,ota9,ota10,description,status} = req.body
    var sql = `INSERT INTO otatable (date,machine_Sl_No,shift, checked_by, ota1, ota2, ota3, ota4, ota5, ota6, ota7, ota8,ota9,ota10,description,status) VALUES ('${date}','Not Provide','${shift}','${operator_name}','${ota1}','${ota2}','${ota3}','${ota4}','${ota5}','${ota6}','${ota7}','${ota8}','${ota9}','${ota10}','${description}','${status}')`;
