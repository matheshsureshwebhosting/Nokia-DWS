...
export default class VacuumTable extends Component {
    ...
    componentDidMount = () => {
        axios.get("http://localhost:4000/getdatas").then((res) => {
            this.setState({
    ...
    shiftfilter = async (e) => {
        ...
        const shiftdata = await axios.get("http://localhost:4000/getdatas").then((res) => {
            return res.data
        })
        if (shift !== "none") {
    ...
    datefilter = async () => {
        ...
        if (from == null) {
            ...
            const datedata = await axios.post("http://localhost:4000/datefiltervaccume", {
                from: from,
                to: to
            }).then((res) => {
                return res.data
    ...
    Resetfilter = async () => {
        const resetdata = await axios.get("http://localhost:4000/getdatas").then((res) => {
            return res.data
        })
        this.setState({
    ...
    exportdata = async () => {
        const exportvaccume = await axios.get("http://localhost:4000/exportvaccume").then((res) => {
            return res.data
        })
